...
3. **Market sizing + unit economics.** Cite external data where possible; **label every number `[cited]` or `[estimate]`.** Stating an estimate as a fact is a recurring, costly error.
